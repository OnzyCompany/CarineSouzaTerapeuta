    ...
    <section id="services" className="py-20 md:py-32 bg-white scroll-mt-20">
      <div className="container mx-auto px-4">
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mt-12 md:mt-20"
        >
          {services.map((service) => (
            <motion.div 
              ...
              whileHover={{ y: -10 }}
              className="bg-[#F8FAFC] p-8 md:p-10 rounded-3xl shadow-sm border border-gray-100 group hover:border-[#01a7aa] transition-all duration-300 hover:bg-white hover:shadow-2xl flex flex-col"
            >
              <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-sm border border-gray-50">
              ...
              <p className="text-gray-600 leading-relaxed font-medium text-lg flex-grow">{service.description}</p>
              
              <div className="w-full h-1.5 bg-gradient-to-r from-[#01a7aa] to-[#dbaf45] mt-8 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left rounded-full"></div>
            </motion.div>
          ))}
        </motion.div>
      </div>
